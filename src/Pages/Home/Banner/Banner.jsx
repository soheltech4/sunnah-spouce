    ...
    return (
        <div className='text-center'>
            ...
            <div className='grid justify-center relative top-0 md:top-10 p-5 items-center'>
                ...
                <h1 className='mt-32 mb-32 md:mx-96 border text-xl rounded-xl p-5 bg-white bg-opacity-50 text-black'>When a person gets married he has completed half of this dee, so let him fear Allah with regard to the other half</h1>
            </div>
            <Search></Search>
        </div>
    );
