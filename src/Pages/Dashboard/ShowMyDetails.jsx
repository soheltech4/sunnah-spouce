...
const ShowMyDetails = ({ user }) => {
    ...
    return (
        <div className='flex gap-x-32 gap-y-5'>
            ...
            <div className="w-full text-black p-5 mt-0 ">
                <div className='bg-gray-500 bg-opacity-25 p-5 mb-5 md:p-5 rounded-lg w-full'>
                    ...
                    <div className=' md:p-5 rounded-lg w-full'>
                        <div className='flex justify-start items-start bg-white rounded-md p-2 my-2 gap-x-52 '>
                        ...
                        <div className='flex bg-white rounded-md p-2 my-2 gap-x-52 '>
                            <div className='font-semibold'>
